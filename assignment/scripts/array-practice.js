...
let favoriteFoods = ['peaches', 'bread', 'chocolate', 'curry', 'broccoli', 'cheese'];
...
console.log('I added another favorite food', favoriteFoods);
...
console.log(`Added a new food to the beginning of the list: ${favoriteFoods}`);
...
favoriteFoods.splice(1, 1, 'croissants');
...
let stringOfFoods = favoriteFoods.join(" and ");
...
let foodsAndCritters = favoriteFoods.concat(animalArray);
console.log(foodsAndCritters);